    ...
    <footer className="bg-foreground text-background">
      <div className="max-w-7xl mx-auto px-4 py-12">
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li>
                <a href="#about" className="text-background/70 hover:text-background transition">
                  About Us
                </a>
              </li>
              <li>
                <a href="#team" className="text-background/70 hover:text-background transition">
                  Our Team
                </a>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-background/70">
              <li>
                <a href={`tel:${config.phone}`} className="hover:text-background transition">
                  {config.phone}
                </a>
              </li>
              <li>
                <a href={`mailto:${config.email}`} className="hover:text-background transition">
                  {config.email}
                </a>
              </li>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-background/70">
              {config.abn && <li>ABN: {config.abn}</li>}
              {config.ndisNumber && <li>NDIS: {config.ndisNumber}</li>}
            </ul>
        ...
        <div className="border-t border-background/20 mt-12 pt-8 text-center text-sm text-background/60">
          ...
          <p className="mt-2">
            <a href="/admin" className="hover:text-background transition">Admin</a>
          </p>
        </div>
      </div>
    </footer>
